...
class TipoDocumentoService  extends SistemaServices
{
    ...
    public function BuscarTipoDocumentoID(int $tipoDoc): string
    {
        $repository = new TipoDocumentoRepository($this->Conexao());
        return $repository->BuscarTipoDocumentoID($tipoDoc);
    }
    ...
    public function listaArmarioTipoDocumento(int $idArmario): array
    {
        try {
            $repository = new TipoDocumentoRepository($this->Conexao());
            return $repository->listaArmariosTipoDocumento($idArmario);
        } catch (Exception $e) {
            echo $e;
            return [];
        }
